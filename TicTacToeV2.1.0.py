...
def pointValidation(listPlayer):
    ...
    # if the possition is according with the winning list then add +1
    # take each items of playerList and do check if that is present in any of the winning list -- by iteration!
    # +1 for presence
...
# baseic gameplot to show at the very beginning --
gamePlot()
maxRun = 0
